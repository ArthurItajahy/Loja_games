...
public class ProdutoController {
	...
	@GetMapping("/nomeandlab/{nome}&&{laboratorio}") // Esse comando traz a lista de Produtos como o Nome do remedio declarado e Laboratorio;
	...
	@GetMapping("/betweenprice/{precoInit}&&{precoEnd}") // Traz uma lista de produtos entre esses dois preços
	public ResponseEntity<List<Produto>> findByEntre (@PathVariable BigDecimal precoInit, @PathVariable BigDecimal precoEnd){
		return ResponseEntity.ok(produtoRepository.findAllByPrecoBetweenOrderByPreco(precoInit, precoEnd));
	}
	@PostMapping
